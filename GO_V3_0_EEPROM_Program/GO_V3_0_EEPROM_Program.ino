...
void loop()
{
	...
	char udpApn[36] = "giffgaff.com"; //SIM card specific APN.  wholesale is used on Platinumtel /**** DEFAULT VALUE STORED IN EEPROM ****/
	char udpHost[36] = "http://watchbug-api.herokuapp.com"; //Server address for GPS-Trace Orange /**** DEFAULT VALUE STORED IN EEPROM ****/
